    ...
    FocusScope {
        ...
        Rectangle {
            ...
            Column {
                ...
                Text { renderType: Text.QtRendering; width: parent.width; wrapMode: Text.Wrap
                       text: dlg.title; color: Theme.fg
                       font.family: Theme.fontFamily; font.hintingPreference: Font.PreferFullHinting; font.pixelSize: 16; font.weight: 700 }
                Text { renderType: Text.QtRendering; visible: dlg.preview.length > 0
                ...
                Row {
                    spacing: 16
                    Text { renderType: Text.QtRendering; text: "⏎ / y  delete"; color: Theme.fg
                           font.family: Theme.fontFamily; font.hintingPreference: Font.PreferFullHinting; font.pixelSize: 13; font.weight: 700 }
                    Text { renderType: Text.QtRendering; text: "esc / n  cancel"; color: Theme.fg_muted
